...
# Data analysis workflow examples {.tabset}
...
Aparte del plot de la PCA en si, también podemos visualizar los loadings, que nos indican la contribución de cada feature en el componente correspondiente:
